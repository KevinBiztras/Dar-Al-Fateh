...
class _LocationScreenState extends State<LocationScreen> {
              ...
              Positioned(
                  ...
                  child: InkWell(
                    ...
                    child:  CircleAvatar(
                      ...
                      child:  Icon(Icons.my_location_sharp,color: Theme.of(context).colorScheme.secondaryContainer,),
                    ),
                  )),
              GestureDetector(
                onTap: () {
  ...
  void getLocation(LatLng latLng) async {
    ...
    print("place api result--------------> ${placemarks.first}");
    if(mounted) {
      setState(() {

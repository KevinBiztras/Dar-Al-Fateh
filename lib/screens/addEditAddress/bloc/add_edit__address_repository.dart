...
abstract class AddEditAddressRepository {
  ...
  Future<BaseModel> guestAddAddress(String name, String phone, String street,
      String city, String zip, String countryId, String stateId,String email);
}
...
class AddEditAddressRepositoryImp extends AddEditAddressRepository {
  ...
  @override
  Future<BaseModel> guestAddAddress(String name, String phone, String street,
      String city, String zip, String countryId, String stateId,String email) async {
    BaseModel model;
    Map<String, dynamic> data = {};
    data["name"] = name;
    data["phone"] = phone;

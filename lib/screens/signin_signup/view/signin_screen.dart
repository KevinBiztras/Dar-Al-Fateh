        ...
        if (state is LoadingState) {
          ...
          WidgetsBinding.instance?.addPostFrameCallback((_) {
            ...
            Navigator.pushNamedAndRemoveUntil(
                context,navBar, (route) => false,arguments: 0);
          });
        ...
        child: SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.symmetric(
                ...
                vertical: AppSizes.buttonRadius),
            child: Column(
  ...
  void checkFingerprint() {
    auth.isDeviceSupported().then((value) {
      if (value) {
        ...
        Navigator.of(context).pushNamedAndRemoveUntil(navBar, (route) => false,arguments: 0);
      }
    });
  }
    ...
    auth.isDeviceSupported().then((value) async {
      if (value) {
        ...
        WidgetsBinding.instance?.addPostFrameCallback((_) {
          AlertMessage.showError(
              _localizations
                      ?.translate(AppStringConstant.authenticationUnable) ??
                  '',
              context);
        });
      }

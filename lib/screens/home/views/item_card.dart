              ...
              children: <Widget>[
                Padding(
                  ...
                  child: ImageView(
                    ...
                    width: widget.imageSize! + AppSizes.normalPadding,
                    height: widget.imageSize! - AppSizes.normalPadding,
                  ),
                ),
                Padding(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: [
                            ...
                            Visibility(
                              visible: (widget.product?.priceReduce ?? '')
                                  .isNotEmpty,
                              ...
                              child: InkWell(
                                onTap: () {
                                  if ((AppSharedPref().getIfLogin() != null &&
                                    ...
                                    } else if (widget.product!.productCount! ==
                                        1) {

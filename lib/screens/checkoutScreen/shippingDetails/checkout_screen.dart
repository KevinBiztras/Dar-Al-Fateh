...
import '../../addEditAddress/bloc/add_edit__address_repository.dart';
            ...
            child: BlocBuilder<CheckoutScreenBloc, CheckoutScreenState>(
              builder: (context, state) {
                if (state is CheckoutScreenInitial) {
                  ...
                  if ((_addressListModel?.defaultShippingAddressId
                      ?.displayName ??
                      "")
                      .trim()
                      .isNotEmpty) {
                  ...
                  WidgetsBinding.instance?.addPostFrameCallback((_) {
                    AppSharedPref().setHasDefaultShipping(isHasDefaultShipping);
                  });
                    ...
                    children: [
                      ...
                      model?.allowShipping ?? false
                          ...
                          addressList: ShippingMethodsView(
                            shippingMethodList: _shippingMethodModel
                                ?.shippingMethods ??
                                [],
                      ...
                      addressList: addNewAddress(
                          ...
                          _localizations?.translate(
                              ...
                              '', () {
                        Navigator.of(context)
                            .pushNamed(addEditAddress, arguments: null)
                            .then((value) {
                          if (value == true) {
                            _checkoutScreenBloc
                                ?.emit(CheckoutScreenInitial());

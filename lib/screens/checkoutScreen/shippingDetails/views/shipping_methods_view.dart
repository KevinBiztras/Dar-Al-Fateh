...
class ShippingMethodsView extends StatefulWidget {
  ...
  ValueChanged<int>? paymentcallback;
...
class _ShippingMethodsState extends State<ShippingMethodsView> {
  ...
  Widget build(BuildContext context) {
    ...
    print(" widget.shippingMethodList --> ${widget.shippingMethodList?.firstOrNull?.toJson() }");
    return Column(
                ...
                RadioListTile<String>(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      // }
                      print("selected payment --> "+value.toString());
                      selectedIndex = index;
                      widget.selectedPaymentIndex= index;
                      if (widget.paymentcallback != null) {
                        widget.paymentcallback!(selectedIndex);
                      }

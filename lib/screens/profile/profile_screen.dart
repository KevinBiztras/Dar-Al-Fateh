...
// import 'package:flutter_project_structure/marketplace/marketplaceScreens/marketplaceProfile/marketplace_profile_menu.dart';
          ...
          builder: (context, currentState) {
            ...
            : Column(
                children: [
                  ...
                  // marketplaceProfileMenu(() {}, _localizations),
                ],
              );
      }),
    );
          ...
          children: [
            profileMenu(
                _localizations,
                    () {
                  setState(() {
                    print('callback method-------- profile screen');
                  });
                }),
          //  marketplaceProfileMenu(() {}, _localizations),

 ...
 */
import 'package:equatable/equatable.dart';import 'package:flutter_project_structure/models/AccountInfoModel.dart';
...
class LoginOnWatchSuccessState extends AccountInfoState{
  final LoginResponseModel data;
  const LoginOnWatchSuccessState(this.data);
}

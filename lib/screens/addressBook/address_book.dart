...
class AddressBook extends StatelessWidget {
      ...
      child: Stack(
        children: [
          _addressListModel != null &&
              ...
              ? ((_addressListModel?.addresses?[0].displayName ?? "")
              .trim()
              .isNotEmpty)
            ...
            child: Column(
              children: [
                ...
                addressItemWithHeading(
                    ...
                    }, () { }, isForDefaultAddress: true,
                        titleLeft: _localizations?.translate(AppStringConstant.changeBillingAddress)),
                    showDivider:true
                ),
                addressItemWithHeading(
                    context,
                    ...
                    actions: actionContainer(context, () {
                      Navigator.of(context)
                        ...
                        isForDefaultAddress: true,
                        titleLeft: _localizations?.translate(AppStringConstant.changeShippingAddress)),
                    showDivider:true
                ),
                ((_addressListModel?.addresses != null) &&
                    (_addressListModel!.addresses!.isNotEmpty) &&
                    (_addressListModel!.addresses!.length > 1))
                    ? addressItemWithHeading(
                    context,
  ...
  Widget getEmptyAddressView(BuildContext context) {
    ...
    return lottieAnimation(
      ...
      lottiePath: (Theme.of(context).brightness == Brightness.light)
  ...
  Widget addressList() {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return (_addressListModel?.addresses?[index].addressId !=
              _addressListModel?.customerId)
              ...
              actions: actionContainer(context, () {
                ...
                DialogHelper.confirmationDialog(AppStringConstant.deleteAddressAlert,context, _localizations, onConfirm: (){
                  _addressBookScreenBloc?.add(DeleteAddressEvent(
                      _addressListModel?.addresses?[index].addressId
                          .toString() ??
                          ''));
                });
              },

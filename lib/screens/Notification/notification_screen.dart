  ...
  Widget emptyNotification(){
    return Center(
      child: Column(
        ...
        children: [
         const  Icon(Icons.notifications, size: 130,),
          Text(_localizations?.translate(AppStringConstant.emptyNotification) ?? '', style:  Theme.of(context).textTheme.headlineSmall,),
        ],
      ),
    );
  }
